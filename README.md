...
메타마스크 지갑을 연결하거나 연결 해제할 수 있습니다.

<img src='readme/connect_wallet.gif' />

### 게임 베팅

1. 원하는 번호에 베팅할 수 있습니다.
2. 컨트랙트에 반영된 후, 해당 숫자에 대한 배당금과 배당율을 확인할 수 있습니다.

<img src='readme/bet_game.gif' width='100%' />

### 게임 결과 확인

1. 시간이 지나면, 자동으로 게임이 종료되고 결과를 확인할 수 있습니다.
2. 선택된 숫자는 초록색, 아닌 숫자는 빨간색으로 표시됩니다.
3. 결과가 반영된 후 상금이 분배됩니다.
4. 내가 획득한 금액이 순위권안에 든다면 리더보드에 기록됩니다.

<img src='readme/game_result.gif' width='100%' />
